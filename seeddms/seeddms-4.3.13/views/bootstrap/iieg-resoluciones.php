...
<p align="center"><img src="https://iieg.gob.mx/transparencia/img//logo_iieg.png"></p>
...
<!--para establecer como invisible una tabla se utiliza el tag: style="display: none"-->
  ...
  <thead>
	  <tr class="encabezado">
	  <td bgcolor="770000"><div align="center" class="Estilo16" style="width: 300px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Resoluci&oacute;n</div></td>  
	  <td bgcolor="770000"><div align="center" class="Estilo16" style="width: 300px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Número de expediente</div></td>
...
/*$query=mysql_query("
						...
						$query=mysql_query("
							...
							FROM
								tblDocuments AS x
								LEFT JOIN ( SELECT * FROM tblDocumentAttributes WHERE attrdef = 17) AS r ON x.id = r.document
...
<!--EL BUENO-->
	<td width="57" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18"><br/><a accesskey="" href="../../data/1048576/<?php echo $info[1];?>/<?php 
	...
	<td width="80" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18"><?php echo $info[0];?></div></td>
