...
<!--para establecer como invisible una tabla se utiliza el tag: style="display: none"-->
  ...
  <thead>
	  ...
	  <td bgcolor="770000"><div align="center" class="Estilo16" style="width: 200px;">Acta de sesi&oacute;n</div></td>
	  <td bgcolor="770000"><div align="center" class="Estilo16" style="width: 350px;">Documentos aprobados</div></td>
	  <td bgcolor="770000"><div align="center" class="Estilo16" style="width: 350px;">TEST::Documentos aprobados</div></td>
...
?>
	...
	<td width="57" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18"><?php echo $info2[1];?></div></td>
	...
	elseif($pptx==$info[11]) {echo "1.pptx";} 
	elseif($txt==$info[11]) {echo "1.txt";}	
	elseif($rar==$info[11]) {echo "f".$info[13].".rar";}
	else	{
	//echo "<img src='../../../../../views/bootstrap/images/404.jpg'>"; 
	echo "../404.jpg";
	}
	...
	elseif($pptx==$info[11]) {echo "1.pptx";} 
	elseif($txt==$info[11]) {echo "1.txt";}	
	elseif($rar==$info[11]) {echo "f".$info[14].".rar";}		
	...
	<?php /*while($actas=@mysql_fetch_array($queryActa))
	{ ?>
<!--PARA mostrar el icono y abrir los rar que se contruyen con dos queries ACTA-->
	<td width="57" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18"><br/><a accesskey="" href="../../data/1048576/<?php echo $actas[0];?>/<?php 
	if($rar==$info[11]) { echo "f".$actas[12].".rar";}
	?>" target="_blank" onMouseover="window.status='Descargar documento'; return true;" onMouseout="window.status='';return true;"><img draggable="false" class="mimeicon" src="../../views/bootstrap/images/<?php 
	if($rar==$info[11]) {echo "rar2.png";} 	
	?>" title="Ver documento"></a><br/><?php echo "<br/>";?></div></td>	
	<?php } ?>
	
	
	<?php while($aprobados=@mysql_fetch_array($queryDoctos))
	{ ?>
	<td width="57" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18"><br/><a accesskey="" href="../../data/1048576/<?php echo $aprobados[0];?>/<?php 
	if($rar==$info[11]) { echo "f".$aprobados[12].".rar";}
	?>" target="_blank" onMouseover="window.status='Descargar documento'; return true;" onMouseout="window.status='';return true;"><img draggable="false" class="mimeicon" src="../../views/bootstrap/images/<?php 
	if($rar==$info[11]) {echo "rar2.png";} 	
	?>" title="Ver documento"></a><br/><?php echo "<br/>";?></div></td>
	<?php } */?>
...
<!-- HITO PARA MOSTRAR LOS ID´S DE CADA UNO DE LOS .RAR
	<td width="57" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18"><?php //while($info2=@mysql_fetch_array($queryActa)) {if($rar==$info2[11]) {echo "f".$info2[12].".rar";}} ?></div></td> 
	<td width="57" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18"><?php //while($info3=@mysql_fetch_array($queryDoctos)) {echo $info3[12];}?></div></td>
	-->
	<td width="57" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18"><?php 
