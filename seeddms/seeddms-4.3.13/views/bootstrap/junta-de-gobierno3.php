...
<div class="row large-centered">
<label ><p align="center"> <FONT FACE="arial" SIZE=4 COLOR=Gray><b>
...
//consulta activa en la p&Atilde;&iexcl;gina
/*$query=mysql_query("
						SELECT
							t.number,							
							g.firstname,
						...
						SELECT
							...
							x.`name` AS `Tipo de Contrato`,
							x.`comment` AS `Tipo de C`,
							t.value AS `Nombre de la persona f&Atilde;&shy;sica o jur&Atilde;&shy;dica`,
							k.value AS Monto,
							m.value AS `Acciones a realizar`,
							n.value AS `Proyecto o partida`,
							p.value AS Vigencia,
						...
						ORDER BY
							...
							//Prueba para obtener los documentos del ACTA DE SESI&Atilde;&ldquo;N
...
?>
  <tr bgcolor="#FFFFFF" class="textoceldas">
    ...
    <!--en esta l&Atilde;&shy;nea se agrega el &Atilde;&shy;cono del pdf para que sea posoble descargar seg&Atilde;&ordm;n la consulta del documento que se guardo en l
    ...
    <td width="57" class="Estilo1" bgcolor="#D8D8D8"><div align="center" class="Estilo18">
        <br/>
      <a accesskey="" href="../../data/1048576/<?php echo $info[0];?>/<?php 
