       ...
       if(!todos) $('.cuerpo-tabla').empty();
        documentos.forEach(function (c, i) {
            var $col = '<tr>' +
                ...
                '           <a href="https://iieg.gob.mx/seeddms-4.3.13/data/1048576/'+c.documento+'/1.pdf" target="_blank">' +
            ...
            documentosConsulta.forEach(function (d) {
                if (d.orgFileName !== null) {
                    var url = '';
                    if (d.name === 'Documentos aprobados') url = 'https://iieg.gob.mx/seeddms-4.3.13/data/1048576/'+c.documento+'/f'+d.id+''+d.fileType;
                    else url = 'https://iieg.gob.mx/seeddms-4.3.13/data/1048576/'+c.documento+'/f'+d.id+''+d.fileType;
            ...
            documentosAprobados.forEach(function (d) {
                if (d.orgFileName !== null) {
                    var url = '';
                    if (d.name === 'Documentos públicos para consulta previa') url = 'https://iieg.gob.mx/seeddms-4.3.13/data/1048576/'+c.documento+'/f'+d.id+''+d.fileType;
                    else url = 'https://iieg.gob.mx/seeddms-4.3.13/data/1048576/'+c.documento+'/f'+d.id+''+d.fileType;
            ...
            actaSesion.forEach(function (d) {
                if (d.orgFileName !== null && d.document == c.documento) {
                    var url = '';
                    if (d.name === 'Acta de sesión') url = 'https://iieg.gob.mx/seeddms-4.3.13/data/1048576/'+c.documento+'/f'+d.id+''+d.fileType;
                    else url = 'https://iieg.gob.mx/seeddms-4.3.13/data/1048576/'+c.documento+'/'+d.id+''+d.fileType;
