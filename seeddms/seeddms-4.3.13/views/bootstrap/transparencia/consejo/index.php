...
<table font-family: Arial, Helvetica, sans-serif; style="height: 21px; width: 100%; border-collapse: collapse; background-color: #7c878e;" border="0">
    ...
    <h3><span style="color: #ffffff;" class="texto-grande">  Consejo Consultivo del Instituto de Informaci&oacute;n Estad&iacute;stica y Geogr&aacute;fica de Jalisco</span></h3>
    </td>
    </tr>
    <tr>
...
<table class="comite" id="datos">
    ...
    <?php //DOCUMENTOS PÚBLIOCOS PARA CONSULTA PREVIA?>
		<?php $query2=mysql_query("
                                ...
                                tblDocuments.name = 'Consejo Consultivo'
                                and tblDocumentAttributes.attrdef=7	
                                and tblDocumentFiles.`name` != 'Acta de sesión'
                                order by tblDocuments.id desc
    ...
    <td>
			...
			?>
				...
				<!--<td align="center"><?php //echo $info2[9];?></td>-->
					...
					<!--<?php //if ($info[2] == $info2[2] and $info2[11] != ""){ echo "<li>".$info2[7]."";}  else {echo "";}?></a> -->
					<?php if (is_null($info3[10])){echo "";} elseif ($info[2] == $info3[2]) {?> <a style="text-decoration:none" accesskey="" href="../../../../data/1048576/<?php echo $info3[2];?>/<?php if ($info3[11]="Acta de seión") echo "f".$info3[10]; else echo $info3[10];?><?php echo $info3[8];?>" target="_blank" >	 <?php echo "<li>".$info3[9]."";}?></a> 
