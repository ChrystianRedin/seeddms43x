...
<p align="center"> <FONT FACE="arial" SIZE=5 COLOR=Gray><b><u>Contratos</u><br><br>Instituto de Informaci&oacute;n Estad&iacute;stica y Geogr&aacute;fica de Jalisco</FONT> </p>
...
<!--para establecer como invisible una tabla se utiliza el tag: style="display: none"-->
  ...
  <tbody>
   <button cellpadding="7" id="btnExport">Exportar a excel</button>
  </tr>
...
//echo $info[0];
    ...
    ?>
<!--EL BUENO-->
	<td width="57" class="Estilo1" bgcolor="#FFFFFF"><div align="center" class="Estilo18"><br/><a accesskey="" href="../../data/1048576/<?php echo $info[0];?>/<?php 
		...
		if($pdf==$info[11]) {$query2=mysql_query("SELECT tblDocumentStatus.version FROM tblDocumentStatus WHERE tblDocumentStatus.documentID = $info[0]");  $info2=@mysql_fetch_array($query2); echo $info2[0].".pdf";	}
		elseif($xls==$info[11]) {$query2=mysql_query("SELECT tblDocumentStatus.version FROM tblDocumentStatus WHERE tblDocumentStatus.documentID = $info[0]");  $info2=@mysql_fetch_array($query2); echo $info2[0].".xls";	} 
		elseif($xlsx==$info[11]) {$query2=mysql_query("SELECT tblDocumentStatus.version FROM tblDocumentStatus WHERE tblDocumentStatus.documentID = $info[0]");  $info2=@mysql_fetch_array($query2); echo $info2[0].".xlsx";	}
		elseif($doc==$info[11]) {$query2=mysql_query("SELECT tblDocumentStatus.version FROM tblDocumentStatus WHERE tblDocumentStatus.documentID = $info[0]");  $info2=@mysql_fetch_array($query2); echo $info2[0].".doc";	}
		elseif($docx==$info[11]) {$query2=mysql_query("SELECT tblDocumentStatus.version FROM tblDocumentStatus WHERE tblDocumentStatus.documentID = $info[0]");  $info2=@mysql_fetch_array($query2); echo $info2[0].".docx";	}
		elseif($ppt==$info[11]) {$query2=mysql_query("SELECT tblDocumentStatus.version FROM tblDocumentStatus WHERE tblDocumentStatus.documentID = $info[0]");  $info2=@mysql_fetch_array($query2); echo $info2[0].".ppt";	}
		elseif($pptx==$info[11]) {$query2=mysql_query("SELECT tblDocumentStatus.version FROM tblDocumentStatus WHERE tblDocumentStatus.documentID = $info[0]");  $info2=@mysql_fetch_array($query2); echo $info2[0].".pptx";	}
		elseif($txt==$info[11]) {$query2=mysql_query("SELECT tblDocumentStatus.version FROM tblDocumentStatus WHERE tblDocumentStatus.documentID = $info[0]");  $info2=@mysql_fetch_array($query2); echo $info2[0].".txt";	}
	...
	<td width="57" class="Estilo1" bgcolor="#FFFFFF"><div align="center" class="Estilo18"><?php echo $info[4];?></div></td>
	<td width="57" class="Estilo1" bgcolor="#FFFFFF"><div align="center" class="Estilo18"><?php echo $info[5];?></div></td>
	<td width="57" class="Estilo1" bgcolor="#FFFFFF"><div align="center" class="Estilo18"><?php echo $info[6];?></div></td>
	<td width="57" class="Estilo1" bgcolor="#FFFFFF"><div align="center" class="Estilo18"><?php echo $info[7];?></div></td>
	<td width="57" class="Estilo1" bgcolor="#FFFFFF"><div align="center" class="Estilo18"><?php echo $info[8];?></div></td>
	<td width="57" class="Estilo1" bgcolor="#FFFFFF"><div align="center" class="Estilo18"><?php echo $info[9];?></div></td>
