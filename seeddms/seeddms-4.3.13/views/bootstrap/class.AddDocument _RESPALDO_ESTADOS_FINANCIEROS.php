...
function mostrar(sel) {
			  if (sel.value=="contra"){
				   divC = document.getElementById("CC");
				   divC.style.display = "";

				   divT = document.getElementById("JG");
...
function mostrar() {
	...
	var y = document.getElementById("JG");
	...
	var z = document.getElementById("JG");
...
?>
		...
		<div>
			...
			<br/>
			<td><input class="btn btn-info" type="button" value= "Contratos y Convenios" onclick="mostrarCC()" ></td>			
			<td><input class="btn btn-info" type="button" value= "Junta de Gobierno" onclick="mostrarJG()" ></td>			
			<td><input class="btn btn-info" type="button" value="Resoluciones" onclick="mostrarRes()"></td>		
			<td><input class="btn btn-info" type="button" value="Estados financieros" onclick="mostrarEstados()"></td>		  
		...
		<table>
			...
			<!--TERMINA EL BLOQUE PARA ESTADOS FINANCIEROS-->
					...
					<tr>
					Seleccionar el tipo de documento: <select class="selectpicker" name="name" value="mostrar" >					
					<option></option>
