...
?>
		...
		//inicio gráfica por tipo de solicitud
		$('#container8').highcharts({
			colors: ['#B45F04','#3104B4','#0489B1','#04B404','#5858FA','#A9E2F3','#0080FF'],
	        chart: {
	            type: 'bar'
	        },
	        title: {
	        ...
	        series: [{
	            ...
	            data: [<?php
							$sql=mysql_query("
								 SELECT value,COUNT(attrdef) as CORREO
									FROM
									tblDocumentAttributes
									INNER JOIN tblDocuments ON tblDocuments.id = tblDocumentAttributes.document
									where attrdef='2'
									and
									tblDocumentAttributes.value like 'correo%'
									and
									tblDocuments.date between 1451606400 and 1482019200
									GROUP BY value
											");
							while($res=mysql_fetch_array($sql)){
							?>
	            ...
	            data: [
					...
					<?php
							$sql=mysql_query("
							SELECT value,COUNT(attrdef) as CORRESPONDENCIA
							FROM
							tblDocumentAttributes
							INNER JOIN tblDocuments ON tblDocuments.id = tblDocumentAttributes.document
							where attrdef='2'
							and
							tblDocumentAttributes.value like 'correspondencia%'
							and
							tblDocuments.date between 1451606400 and 1482019200
							GROUP BY value
											");
	            ...
	            data: [
					...
					<?php
							$sql=mysql_query("
							SELECT value,COUNT(attrdef) as EMAIL
							FROM
							tblDocumentAttributes
							INNER JOIN tblDocuments ON tblDocuments.id = tblDocumentAttributes.document
							where attrdef='2'
							and
							tblDocumentAttributes.value like 'Email%'
							and
							tblDocuments.date between 1451606400 and 1482019200
							GROUP BY value
											");
	            ...
	            data: [
					...
					<?php
							$sql=mysql_query("
							SELECT value,COUNT(attrdef) as OFICIO
							FROM
							tblDocumentAttributes
							INNER JOIN tblDocuments ON tblDocuments.id = tblDocumentAttributes.document
							where attrdef='2'
							and
							tblDocumentAttributes.value like 'oficio%'
							and
							tblDocuments.date between 1451606400 and 1482019200
							GROUP BY value
											");
	            ...
	            data: [
					...
					<?php
							$sql=mysql_query("
							SELECT value,COUNT(attrdef) as VERBAL
							FROM
							tblDocumentAttributes
							INNER JOIN tblDocuments ON tblDocuments.id = tblDocumentAttributes.document
							where attrdef='2'
							and
							tblDocumentAttributes.value like 'Verbal%'
							and
							tblDocuments.date between 1451606400 and 1482019200
							GROUP BY value
											");
	            ...
	            data: [
					...
					<?php
							$sql=mysql_query("
							SELECT value,COUNT(attrdef) as VIATELEFONICA
							FROM
							tblDocumentAttributes
							INNER JOIN tblDocuments ON tblDocuments.id = tblDocumentAttributes.document
							where attrdef='2'
							and
							tblDocumentAttributes.value like 'Via%'
							and
							tblDocuments.date between 1451606400 and 1482019200
							GROUP BY value
											");
	            ...
	            data: [
					...
					<?php
							$sql=mysql_query("
							SELECT value,COUNT(attrdef) as WEB
							FROM
							tblDocumentAttributes
							INNER JOIN tblDocuments ON tblDocuments.id = tblDocumentAttributes.document
							where attrdef='2'
							and
							tblDocumentAttributes.value like 'web%'
							and
							tblDocuments.date between 1451606400 and 1482019200
							GROUP BY value
											");
		...
		//fin de gráfico por tipo de solicitud
...
<!--manda llamar a todos-->
    ...
    <!--<div style="border-top:1px solid #000000;margin:10px;padding:0;clear:both;"></div>-->
		...
		<?php
								//para contar cuantas agregó Fernanda Bringas mediante el módulo de sube
								$query=mysql_query("
								SELECT
		            count(tblDocuments.id) as 'Las solicitudes cargadas por Fernanda de UEF mediante el módulo SUBE son en total'
								FROM
								tblDocuments
								INNER JOIN tblFolders ON tblDocuments.folder = tblFolders.id
								WHERE
		            tblDocuments.owner = 43 and MONTH( FROM_UNIXTIME( tblDocuments.date ) ) BETWEEN 1 AND 12
		            AND YEAR( FROM_UNIXTIME( tblDocuments.date ) ) =2016
								ORDER BY
		            tblDocuments.id ASC");
								//$consulta=@mysql_query($query);
								//$total=@mysql_num_rows($query) ;
								$booked_row = mysql_fetch_array($query,MYSQL_ASSOC);
								print_r($booked_row);
								//echo $booked_row;
								//while($totuef1=@mysql_fetch_array($sube)){
								//$totalesuef=$totuef1;
							//}

								//para contar cuantas agregó Fernanda Bringas mediante el módulo de sube ?>
		<div style="border-top:1px solid #000000;margin:10px;padding:0;clear:both;"></div>
		<div id="container8" style="width: 50%; height: 350px; margin: 0 auto;float:left;"></div>
		<!--<div style="border-top:1px solid #000000;margin:10px;padding:0;clear:both;"></div>-->
